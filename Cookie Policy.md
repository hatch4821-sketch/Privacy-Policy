...
On mobile devices, you can control advertising IDs through:
- iOS: Settings → Privacy → Advertising
- Android: Settings → Privacy → Ads

### 5.3 In-App Settings

You can adjust privacy preferences in our app Settings.

---

## 6. Do Not Track

We do not currently respond to "Do Not Track" signals. We may implement this in the future.
